...
//         s.insert(num);
//         // s.insert(num); // for your BST and AVL sets, you'll need to change this to s.add(num)
//         //  for your LinkedList set, you can change it to s.insertHead(num)
//     }
...
int main(int argc, char *argv[])
{
    ...
    {
        num = rand();
        s.erase(num); // for your LinkedList, BST, and AVL sets, you'll need to change this to s.remove(num)
    }
